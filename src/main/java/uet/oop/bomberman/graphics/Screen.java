 ...
 */
public class Screen {
    // kích cỡ màn hình rộng _width và cao _height
    protected int _width, _height;
   // mảng pixel với mỗi phần tử đại diện cho 1 đơn vị (kích cỡ 1x1) trên toàn màn hình
    public int[] _pixels;
    // khai báo màu tổng quát cho toàn chương trình
    private int _transparentColor = 0xffff00ff;
    // toạ độ x và y trên màn hình của 1 vật thể
