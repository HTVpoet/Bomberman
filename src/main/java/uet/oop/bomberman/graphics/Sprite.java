...
public class Sprite {
    ...
    /**
     * khởi tạo 1 phần ảnh với kích cỡ ,toạ độ xy của nó ở ảnh lớn, SpriteSheet, ép về chiều dài rộng
     * @param size
     * @param x
     * @param y
     * @param sheet
    ...
    /**
     * tương tự giống với SpriteSheet thì SpriteSheet1 cũng vậy
     * @param size
     * @param x
     * @param y
     * @param sheet1
    ...
    // khởi tạo 1 đồ hoạ với kích cỡ và màu sắc
    public Sprite(int size, int color) {
        SIZE = size;
        _pixels = new int[SIZE * SIZE];
        setColor(color);
    }
    // cài dặt màu sắc cho pixel
